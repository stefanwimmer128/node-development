(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["development"] = factory(require("lodash"));
	else
		root["development"] = factory(root["lodash"]);
...
function development(_default, development, production) {
    ...
    var mode = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : POST_DEFAULT;

    if (!(typeof env === 'string')) {
        throw new TypeError("Value of argument \"env\" violates contract.\n\nExpected:\nstring\n\nGot:\n" + _inspect(env));
    }

    if (!(typeof mode === 'number')) {
        throw new TypeError("Value of argument \"mode\" violates contract.\n\nExpected:\nnumber\n\nGot:\n" + _inspect(mode));
    }
